...
src/
  ai_runtime/          # distributable application package
    ...
    providers/         # concrete model-provider adapters (OpenAI and Anthropic via httpx)
